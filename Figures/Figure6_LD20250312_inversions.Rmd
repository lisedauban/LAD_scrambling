---
title: "Figure6_LD20231128_inversions"
date: "2023-11-28"
output: 
  html_document:
...
# Figure 6A - pA-DamID of the locus
```{r}
# data
...
# save
ggsave("Fig6A_LD20230623_locus.pdf", path = "./output/", height = 10, width = 30)


```


# Figure 6D - pA-DamID to go with the domainograms
```{r}
...
ggsave("Fig6D_LD20231218_locus.pdf", path = "./output/", height = 10, width = 30)

```


# Figure 6E-F - pA-DamID to go with the domainograms
```{r}
...
ggsave("Fig6EF_LD20231218_locus.pdf", path = "./output/", height = 10, width = 30)
