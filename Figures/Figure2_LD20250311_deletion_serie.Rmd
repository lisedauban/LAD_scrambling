...
# Figure 2A - Big LAD with the 6 deletions
```{r}
# data
...
## location of clones
clones.df = data.frame(sample = c('donor', 'T179', 'T44', 'T65', 'T162', 'T24', 'T48h20'),
           x = c(110927601, 111711810, 111912792, 112396323, 112440815, 112637307, 112877498),
           y = rep(-4, 7),
           xend = c(110927601, 111711810, 111912792, 112396323, 112440815, 112637307, 112877498),
           yend = rep(-3.5, 7))
...
# save
ggsave("Fig2A_locus.pdf", path = "./output/", height = 10, width = 20)
...
# save
ggsave("Fig2D_locus.pdf", path = "./output/", height = 10, width = 20)
