...
# save
ggsave("Fig1B_locus.pdf", path = "./output/", height = 10, width = 20)
...
# save
ggsave("Fig1C_LD20230919b_Hopping_iLAD.pdf", path = "./output/", height = 10, width = 20)
...
# Figure 1D - SB hopping behaviour in Tdgf1 big LAD
```{r}
...
# save
ggsave("Fig1D_LD20230919b_Hopping_bigLAD2.pdf", path = "./output/", height = 10, width = 20)
...
# Figure 1E - SB hopping behaviour in Tdgf1 small LAD
```{r}
...
# save
ggsave("Fig1E_LD20230919b_Hopping_smallLAD2.pdf", path = "./output/", height = 10, width = 20)
...
# Figure 1F - Cre recombination
```{r}
rec_eff_table <- read.table("/DATA/usr/l.dauban/projects/Paper/revisions/rec_eff_graph.txt", header = TRUE)
...
ggsave("Fig1F_LD20230718_rec_eff.pdf", path = "./output/", width = 10, height = 6)
